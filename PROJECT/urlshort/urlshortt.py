...
my_image=PhotoImage(file="C:\\Users\\nikhiil\\Desktop\pythoncode\\urlshort\\p3.png")
lb1=Label(image=my_image).pack()

e = Entry(win , font=(20))
e.place(relwidth=.6 ,relx= .2, rely=.2)

paste = Image.open('C:\\Users\\nikhiil\\Desktop\\pythoncode\\urlshort\\paste.png')
...
copy = Image.open('C:\\Users\\nikhiil\\Desktop\\pythoncode\\urlshort\\copy.png')
